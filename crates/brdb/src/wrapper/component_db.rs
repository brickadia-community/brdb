...
pub static STRUCT_DEFAULTS: LazyLock<Vec<(&'static str, Vec<(&'static str, Box<dyn AsBrdbValue>)>)>> =
    LazyLock::new(|| vec![
        ...
        ("BrickComponentData_Internal_AttachedZone", vec![
            ...
            ("WaterScattering", Box::new(NestedStructDefault(vec![("X", Box::new(7e-6f64) as Box<dyn AsBrdbValue>), ("Y", Box::new(1.8e-5f64)), ("Z", Box::new(3.1e-5f64))]))),
            ("WaterAbsorption", Box::new(NestedStructDefault(vec![("X", Box::new(0.0065f64) as Box<dyn AsBrdbValue>), ("Y", Box::new(0.000708f64)), ("Z", Box::new(0.000196f64))]))),
        ...
        ("BrickComponentData_WireGraph_Exec_Gamemode_FillArrayFromPlayers", vec![
            ("bIncludeBuilderMode", Box::new(false)),
        ]),
